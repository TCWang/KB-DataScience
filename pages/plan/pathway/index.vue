<template>
  <div class="container">
    <h1 class="px-2">Carrier Pathway - Data Science</h1>
    <div class="flex flex-row flex-wrap">
      <div class="w-full md:w-1/2 p-2 shadow-md">
        <h2>How to Become a Data Scientist?</h2>
        According to
        <a
          href="https://www.simplilearn.com/tutorials/data-science-tutorial/how-to-become-a-data-scientist"
...
<script setup>
useHead({
  title: "DS-Carrier Pathway",
  meta: [
    {
      name: "description",
      content: "Data Science:  Carrier Plan/Pathway",
    },
  ],
});
</script>
